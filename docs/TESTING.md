...
A candidate is not ready just because the quick 30-prompt refusal probe says 0%, and 0% refusal is not automatically the target. For writeup/model-card readiness, require:

- expanded refusal eval result with a large prompt count and category breakdown of retained refusals
